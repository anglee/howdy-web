...
import getPermutation from './060-PermutationSequence';


describe('LeeOJ 060-PermutationSequence', () => {
  describe('getPermutation', () => {
    it('should solve the given example', () => {
      ...
      expect(getPermutation(4, 2)).to.equal('1243');
      expect(getPermutation(4, 24)).to.equal('4321');
    });
  });
});
