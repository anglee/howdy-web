/*
 ...
 Given M busy-time slots of N people, You need to print all the available time slots when all
 the N people can schedule a meeting for a duration of K minutes.
...
describe('Amz_MeetingSchedules', () => {
  it('should work with sample input 1', () => {
...
10 00 13 15
09 00 11 00`;
    const sampleOutput = `00 00 09 00
17 00 20 45`;
    expect(solution(sampleInput)).to.equal(sampleOutput);
  });

  it('should work with sample input 2', () => {
    const sampleInput = `8 60
08 00 10 15
22 00 23 15
17 00 19 00
07 00 09 45
...
12 00 13 30
11 30 12 30`;
    const sampleOutput = `00 00 07 00
13 30 16 00
19 00 22 00`;
    expect(solution(sampleInput)).to.equal(sampleOutput);
  });
