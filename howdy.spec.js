...
import {TreeNode} from './howdy';

describe('howdy', () => {
  it('should identify empty tree', () => {
  ...
  it('should identify single 2-node tree', () => {
    const root = new TreeNode();
    root.insert(9);
  ...
  it('should identify single 3-node tree', () => {
    const root = new TreeNode();
    root.insert(9);
    root.insert(5);
  ...
  it('should handle inserting 3-node leaf node', () => {
    const root = new TreeNode();
    root.insert(9);
    root.insert(5);
    root.insert(8);
