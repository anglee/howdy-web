...
describe('solution', () => {
  xit('should work with sample case', () => {
...
91`;
  ...
  it('should work with sample case', () => {
    const sampleInput = fs.readFileSync('./sampleTest6.input').toString();
    const sampleOutput = fs.readFileSync('./sampleTest6.output').toString();
